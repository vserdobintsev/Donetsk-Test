    ...
    public function message()
    {
        ...
        switch (true) {
            ...
            case $this->requireUppercase
                ...
                && !$this->requireNumeric:
                return __('The :attribute must be at least :length characters and contain at least one uppercase character and contain at least one lowercase character and one special character.', [
                    'length' => $this->length,
                ]);
